...
class TransformationOperation implements RunnableBuildOperation {
    ...
    TransformationOperation(CacheableInvocation<TransformationSubject> invocation, String displayName, ComponentArtifactIdentifier artifactIdentifier, Map<ComponentArtifactIdentifier, TransformationResult> results) {
